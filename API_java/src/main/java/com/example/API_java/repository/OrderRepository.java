...
public interface OrderRepository extends JpaRepository<Order, Long> {
    ...
    @org.springframework.data.jpa.repository.Query("SELECT COALESCE(SUM(o.totalPrice), 0) FROM Order o WHERE o.userId = :userId AND (o.status = 'completed' OR o.paymentStatus = 'PAID')")
